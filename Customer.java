...
public class Customer implements Comparable<Customer>
{
	...
	//Here compareTo is overwritten and wil be used to sort the arraylist of objects
	//Later on in the program.
	@Override
	public int compareTo(Customer otherCustomer)
	{
		return this.getName().compareTo(otherCustomer.getName());
	}
}
